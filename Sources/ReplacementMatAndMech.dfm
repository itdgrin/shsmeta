object frmReplacement: TfrmReplacement
  ...
  object Panel1: TPanel
    ...
    object Panel2: TPanel
      ...
      object rgroupWhere: TRadioGroup
        Left = 0
        Top = 53
        Width = 152
        Height = 74
        Align = alClient
        Items.Strings = (
          #1055#1086' '#1088#1072#1089#1094#1077#1085#1082#1077
          #1055#1086' '#1089#1084#1077#1090#1077
          #1055#1086' '#1086#1073#1098#1077#1082#1090#1091)
        TabOrder = 1
        OnClick = rgroupWhereClick
      end
    end
    object groupReplace: TGroupBox
      ...
      object Label7: TLabel
        ...
        Width = 130
        Height = 13
        Caption = #1050#1086#1101#1092#1092#1080#1094#1080#1077#1085#1090' '#1087#1077#1088#1077#1089#1095#1077#1090#1072':'
      end
    ...
    object Panel5: TPanel
      ...
      object ListSpr: TListView
        ...
        Items.ItemData = {
          ...
          000633003200320034003300320000000000FFFFFFFFFFFFFFFF00000000FFFF
          FFFF00000000083200340034003200330034003200330000000000FFFFFFFFFF
  ...
  object qrEntry: TFDQuery
    BeforeInsert = qrEntryBeforeInsert
    Connection = DM.Connect
    Transaction = DM.Read
    UpdateTransaction = DM.Write
    ...
    Left = 296
    Top = 185
    object qrEntrySEL: TBooleanField
      FieldName = 'SEL'
      OnChange = qrEntrySELChange
    end
    object qrEntrySMID: TIntegerField
      FieldName = 'SMID'
      ReadOnly = True
    end
    object qrEntrySMNAME: TStringField
      FieldName = 'SMNAME'
      ReadOnly = True
      Size = 80
    end
    object qrEntryRTID: TIntegerField
      FieldName = 'RTID'
      ReadOnly = True
    end
    object qrEntryRTCODE: TStringField
      FieldName = 'RTCODE'
      ReadOnly = True
    end
    object qrEntryMTID: TIntegerField
      FieldName = 'MTID'
      ReadOnly = True
    end
    object qrEntryMTCODE: TStringField
      FieldName = 'MTCODE'
      ReadOnly = True
    end
    object qrEntryMTCOUNT: TFloatField
      FieldName = 'MTCOUNT'
      ReadOnly = True
    end
    object qrEntryMTUNIT: TStringField
      FieldName = 'MTUNIT'
      ReadOnly = True
    end
  end
