...
// (DO NOT EDIT: machine generated header) 'frxDesgn.pas' rev: 26.00 (Windows)
...
public:
	...
	virtual void __fastcall DisableInspectorUpdate(void);
	virtual void __fastcall EnableInspectorUpdate(void);
