...
// (DO NOT EDIT: machine generated header) 'frxDB19.pas' rev: 26.00 (Windows)
...
#include <frxEditMD.hpp>	// Pascal unit
#include <frxEditQueryParams.hpp>	// Pascal unit
#include <frxEditSQL.hpp>	// Pascal unit
...
#if !defined(DELPHIHEADER_NO_IMPLICIT_NAMESPACE_USE) && !defined(NO_USING_NAMESPACE_FRXDB19)
using namespace Frxdb19;
#endif
#pragma pack(pop)
#pragma option pop
