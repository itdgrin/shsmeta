...
// (DO NOT EDIT: machine generated header) 'frxTee19.pas' rev: 26.00 (Windows)
...
#if !defined(DELPHIHEADER_NO_IMPLICIT_NAMESPACE_USE) && !defined(NO_USING_NAMESPACE_FRXTEE19)
using namespace Frxtee19;
#endif
#pragma pack(pop)
#pragma option pop
