...
// (DO NOT EDIT: machine generated header) 'dclfrxe19.pas' rev: 26.00 (Windows)
...
#include <frxeReg.hpp>	// Pascal unit
...
#include <frxExportDOCX.hpp>	// Pascal unit
#include <frxExportPPTX.hpp>	// Pascal unit
#include <frxExportXLSX.hpp>	// Pascal unit
...
#if !defined(DELPHIHEADER_NO_IMPLICIT_NAMESPACE_USE) && !defined(NO_USING_NAMESPACE_DCLFRXE19)
using namespace Dclfrxe19;
#endif
#pragma pack(pop)
#pragma option pop
