...
// (DO NOT EDIT: machine generated header) 'dclfrxTee19.pas' rev: 26.00 (Windows)

#ifndef Dclfrxtee19HPP
#define Dclfrxtee19HPP
...
#include <frxRegTee.hpp>	// Pascal unit
...
#include <VCLTee.TeeHtml.hpp>	// Pascal unit
#include <VCLTee.TeeConst.hpp>	// Pascal unit
#include <VCLTee.TeCanvas.hpp>	// Pascal unit
#include <VCLTee.TeeFilters.hpp>	// Pascal unit
#include <VCLTee.TeeProcs.hpp>	// Pascal unit
#include <VCLTee.TeEngine.hpp>	// Pascal unit
#include <VCLTee.Chart.hpp>	// Pascal unit
#include <VCLTee.TeeSpline.hpp>	// Pascal unit
...
#include <frxChartHelpers.hpp>	// Pascal unit
#include <fs_ichartrtti.hpp>	// Pascal unit
#include <frxChartRTTI.hpp>	// Pascal unit
...
#include <VCLTee.TeeGDIPlus.hpp>	// Pascal unit
#include <VCLTee.TeeGalleryPanel.hpp>	// Pascal unit
#include <frxChartEditor.hpp>	// Pascal unit
#include <frxChart.hpp>	// Pascal unit

//-- user supplied -----------------------------------------------------------

namespace Dclfrxtee19
{
//-- type declarations -------------------------------------------------------
//-- var, const, procedure ---------------------------------------------------
}	/* namespace Dclfrxtee19 */
#if !defined(DELPHIHEADER_NO_IMPLICIT_NAMESPACE_USE) && !defined(NO_USING_NAMESPACE_DCLFRXTEE19)
using namespace Dclfrxtee19;
#endif
#pragma pack(pop)
#pragma option pop
