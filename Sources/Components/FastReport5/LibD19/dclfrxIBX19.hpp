...
// (DO NOT EDIT: machine generated header) 'dclfrxIBX19.pas' rev: 26.00 (Windows)

#ifndef Dclfrxibx19HPP
#define Dclfrxibx19HPP
...
#include <frxIBXReg.hpp>	// Pascal unit
...
#include <IBSQLMonitor.hpp>	// Pascal unit
#include <IB.hpp>	// Pascal unit
#include <IBIntf.hpp>	// Pascal unit
#include <IBDatabase.hpp>	// Pascal unit
#include <fs_iibxrtti.hpp>	// Pascal unit
#include <frxIBXRTTI.hpp>	// Pascal unit
#include <frxIBXEditor.hpp>	// Pascal unit
#include <frxIBXComponents.hpp>	// Pascal unit

//-- user supplied -----------------------------------------------------------

namespace Dclfrxibx19
{
//-- type declarations -------------------------------------------------------
//-- var, const, procedure ---------------------------------------------------
}	/* namespace Dclfrxibx19 */
#if !defined(DELPHIHEADER_NO_IMPLICIT_NAMESPACE_USE) && !defined(NO_USING_NAMESPACE_DCLFRXIBX19)
using namespace Dclfrxibx19;
#endif
#pragma pack(pop)
#pragma option pop
