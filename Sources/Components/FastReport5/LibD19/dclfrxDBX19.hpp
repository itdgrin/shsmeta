...
// (DO NOT EDIT: machine generated header) 'dclfrxDBX19.pas' rev: 26.00 (Windows)

#ifndef Dclfrxdbx19HPP
#define Dclfrxdbx19HPP
...
#include <frxDBXReg.hpp>	// Pascal unit
...
#include <frxDBXRTTI.hpp>	// Pascal unit
#include <frxDBXEditor.hpp>	// Pascal unit
#include <frxDBXComponents.hpp>	// Pascal unit

//-- user supplied -----------------------------------------------------------

namespace Dclfrxdbx19
{
//-- type declarations -------------------------------------------------------
//-- var, const, procedure ---------------------------------------------------
}	/* namespace Dclfrxdbx19 */
#if !defined(DELPHIHEADER_NO_IMPLICIT_NAMESPACE_USE) && !defined(NO_USING_NAMESPACE_DCLFRXDBX19)
using namespace Dclfrxdbx19;
#endif
#pragma pack(pop)
#pragma option pop
