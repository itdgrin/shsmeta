...
// (DO NOT EDIT: machine generated header) 'frxADO19.pas' rev: 26.00 (Windows)
...
#if !defined(DELPHIHEADER_NO_IMPLICIT_NAMESPACE_USE) && !defined(NO_USING_NAMESPACE_FRXADO19)
using namespace Frxado19;
#endif
#pragma pack(pop)
#pragma option pop
