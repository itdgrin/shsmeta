...
// (DO NOT EDIT: machine generated header) 'dclfrxBDE19.pas' rev: 26.00 (Windows)

#ifndef Dclfrxbde19HPP
#define Dclfrxbde19HPP
...
#include <frxBDEReg.hpp>	// Pascal unit
...
#include <fs_ibdertti.hpp>	// Pascal unit
#include <frxBDERTTI.hpp>	// Pascal unit
#include <frxBDEEditor.hpp>	// Pascal unit
#include <frxBDEComponents.hpp>	// Pascal unit

//-- user supplied -----------------------------------------------------------

namespace Dclfrxbde19
{
//-- type declarations -------------------------------------------------------
//-- var, const, procedure ---------------------------------------------------
}	/* namespace Dclfrxbde19 */
#if !defined(DELPHIHEADER_NO_IMPLICIT_NAMESPACE_USE) && !defined(NO_USING_NAMESPACE_DCLFRXBDE19)
using namespace Dclfrxbde19;
#endif
#pragma pack(pop)
#pragma option pop
