...
uses
  ...
  fs_iinterpreter, Printers, frxWatchForm, frxPictureCache, Variants
{$IFDEF Delphi9}
, GraphUtil, Tabs
{$ENDIF}
{$IFDEF DELPHI16}
...
{$ENDIF}
  ...
  and (FReportTree.Name  = 'frxReportTreeForm') and (FWatchList.Name = 'frxWatchForm') then
...
begin
  RegisterComponents('Fast Report 5',[TfrxDesigner]);
end;
