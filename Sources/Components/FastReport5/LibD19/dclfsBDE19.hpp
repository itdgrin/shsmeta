...
// (DO NOT EDIT: machine generated header) 'dclfsBDE19.pas' rev: 26.00 (Windows)

#ifndef Dclfsbde19HPP
#define Dclfsbde19HPP
...
#include <fs_ibdereg.hpp>	// Pascal unit
...
namespace Dclfsbde19
{
//-- type declarations -------------------------------------------------------
//-- var, const, procedure ---------------------------------------------------
}	/* namespace Dclfsbde19 */
#if !defined(DELPHIHEADER_NO_IMPLICIT_NAMESPACE_USE) && !defined(NO_USING_NAMESPACE_DCLFSBDE19)
using namespace Dclfsbde19;
#endif
#pragma pack(pop)
#pragma option pop
