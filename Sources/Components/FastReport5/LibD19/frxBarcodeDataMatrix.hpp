...
// (DO NOT EDIT: machine generated header) 'frxBarcodeDataMatrix.pas' rev: 26.00 (Windows)
...
extern DELPHI_PACKAGE void __fastcall GenerateECC(System::Byte *wd, const int wd_Size, int nd, int datablock, int nc);
}	/* namespace Frxbarcodedatamatrix */
