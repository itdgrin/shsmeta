...
// (DO NOT EDIT: machine generated header) 'fs_iclassesrtti.pas' rev: 26.00 (Windows)
...
#if !defined(DELPHIHEADER_NO_IMPLICIT_NAMESPACE_USE) && !defined(NO_USING_NAMESPACE_FS_ICLASSESRTTI)
