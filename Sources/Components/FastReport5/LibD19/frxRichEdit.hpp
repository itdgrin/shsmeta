...
// (DO NOT EDIT: machine generated header) 'frxRichEdit.pas' rev: 26.00 (Windows)
...
public:
	/* TConversion.Create */ inline __fastcall virtual TOEMConversion(void) : Vcl::Comctrls::TConversion() { }
...
public:
	...
	CHARRANGE __fastcall GetSelection(void);
