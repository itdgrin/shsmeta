...
// (DO NOT EDIT: machine generated header) 'fsBDE19.pas' rev: 26.00 (Windows)
...
#if !defined(DELPHIHEADER_NO_IMPLICIT_NAMESPACE_USE) && !defined(NO_USING_NAMESPACE_FSBDE19)
using namespace Fsbde19;
#endif
#pragma pack(pop)
#pragma option pop
