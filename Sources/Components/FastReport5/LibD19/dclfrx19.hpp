...
// (DO NOT EDIT: machine generated header) 'dclfrx19.pas' rev: 26.00 (Windows)
...
#include <frxReg.hpp>	// Pascal unit
...
#include <frxBarcode2DRTTI.hpp>	// Pascal unit
#include <frxBarcode2D.hpp>	// Pascal unit
...
#if !defined(DELPHIHEADER_NO_IMPLICIT_NAMESPACE_USE) && !defined(NO_USING_NAMESPACE_DCLFRX19)
using namespace Dclfrx19;
#endif
#pragma pack(pop)
#pragma option pop
