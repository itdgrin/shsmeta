...
// (DO NOT EDIT: machine generated header) 'dclfsADO19.pas' rev: 26.00 (Windows)

#ifndef Dclfsado19HPP
#define Dclfsado19HPP
...
#include <fs_iadoreg.hpp>	// Pascal unit
...
namespace Dclfsado19
{
//-- type declarations -------------------------------------------------------
//-- var, const, procedure ---------------------------------------------------
}	/* namespace Dclfsado19 */
#if !defined(DELPHIHEADER_NO_IMPLICIT_NAMESPACE_USE) && !defined(NO_USING_NAMESPACE_DCLFSADO19)
using namespace Dclfsado19;
#endif
#pragma pack(pop)
#pragma option pop
