...
// (DO NOT EDIT: machine generated header) 'dclfsDB19.pas' rev: 26.00 (Windows)
...
#include <fs_idbreg.hpp>	// Pascal unit
...
#include <fs_idbctrlsrtti.hpp>	// Pascal unit
...
#if !defined(DELPHIHEADER_NO_IMPLICIT_NAMESPACE_USE) && !defined(NO_USING_NAMESPACE_DCLFSDB19)
using namespace Dclfsdb19;
#endif
#pragma pack(pop)
#pragma option pop
