...
begin
  ...
  BrushBackColorCB.SetBounds(136, 40, 153, 21);
  ...
  BrushForeColorCB.SetBounds(136, 68, 153, 21);
  ...
  GradientStartColorCB.SetBounds(136, 40, 153, 21);
  ...
  GradientEndColorCB.SetBounds(136, 68, 153, 21);
  ...
  GlassColorCB.SetBounds(136, 40, 153, 21);
