...
// (DO NOT EDIT: machine generated header) 'fsDB19.pas' rev: 26.00 (Windows)
...
#if !defined(DELPHIHEADER_NO_IMPLICIT_NAMESPACE_USE) && !defined(NO_USING_NAMESPACE_FSDB19)
using namespace Fsdb19;
#endif
#pragma pack(pop)
#pragma option pop
