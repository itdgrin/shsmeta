...
// (DO NOT EDIT: machine generated header) 'dclfsTee19.pas' rev: 26.00 (Windows)

#ifndef Dclfstee19HPP
#define Dclfstee19HPP
...
namespace Dclfstee19
{
//-- type declarations -------------------------------------------------------
//-- var, const, procedure ---------------------------------------------------
}	/* namespace Dclfstee19 */
#if !defined(DELPHIHEADER_NO_IMPLICIT_NAMESPACE_USE) && !defined(NO_USING_NAMESPACE_DCLFSTEE19)
using namespace Dclfstee19;
#endif
#pragma pack(pop)
#pragma option pop
