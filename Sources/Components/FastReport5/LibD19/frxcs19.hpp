...
// (DO NOT EDIT: machine generated header) 'frxcs19.pas' rev: 26.00 (Windows)
...
#include <frxCGIClient.hpp>	// Pascal unit
...
#if !defined(DELPHIHEADER_NO_IMPLICIT_NAMESPACE_USE) && !defined(NO_USING_NAMESPACE_FRXCS19)
using namespace Frxcs19;
#endif
#pragma pack(pop)
#pragma option pop
