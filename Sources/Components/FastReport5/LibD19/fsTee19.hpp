...
// (DO NOT EDIT: machine generated header) 'fsTee19.pas' rev: 26.00 (Windows)
...
#if !defined(DELPHIHEADER_NO_IMPLICIT_NAMESPACE_USE) && !defined(NO_USING_NAMESPACE_FSTEE19)
using namespace Fstee19;
#endif
#pragma pack(pop)
#pragma option pop
