...
// (DO NOT EDIT: machine generated header) 'dclfrxDB19.pas' rev: 26.00 (Windows)

#ifndef Dclfrxdb19HPP
#define Dclfrxdb19HPP
...
namespace Dclfrxdb19
{
//-- type declarations -------------------------------------------------------
//-- var, const, procedure ---------------------------------------------------
}	/* namespace Dclfrxdb19 */
#if !defined(DELPHIHEADER_NO_IMPLICIT_NAMESPACE_USE) && !defined(NO_USING_NAMESPACE_DCLFRXDB19)
using namespace Dclfrxdb19;
#endif
#pragma pack(pop)
#pragma option pop
