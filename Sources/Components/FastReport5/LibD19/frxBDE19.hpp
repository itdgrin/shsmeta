...
// (DO NOT EDIT: machine generated header) 'frxBDE19.pas' rev: 26.00 (Windows)
...
#if !defined(DELPHIHEADER_NO_IMPLICIT_NAMESPACE_USE) && !defined(NO_USING_NAMESPACE_FRXBDE19)
using namespace Frxbde19;
#endif
#pragma pack(pop)
#pragma option pop
