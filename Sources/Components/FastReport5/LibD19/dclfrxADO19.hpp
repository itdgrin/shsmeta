...
// (DO NOT EDIT: machine generated header) 'dclfrxADO19.pas' rev: 26.00 (Windows)

#ifndef Dclfrxado19HPP
#define Dclfrxado19HPP
...
#include <frxADOReg.hpp>	// Pascal unit
...
#include <frxADORTTI.hpp>	// Pascal unit
#include <frxADOEditor.hpp>	// Pascal unit
#include <frxADOComponents.hpp>	// Pascal unit

//-- user supplied -----------------------------------------------------------

namespace Dclfrxado19
{
//-- type declarations -------------------------------------------------------
//-- var, const, procedure ---------------------------------------------------
}	/* namespace Dclfrxado19 */
#if !defined(DELPHIHEADER_NO_IMPLICIT_NAMESPACE_USE) && !defined(NO_USING_NAMESPACE_DCLFRXADO19)
using namespace Dclfrxado19;
#endif
#pragma pack(pop)
#pragma option pop
