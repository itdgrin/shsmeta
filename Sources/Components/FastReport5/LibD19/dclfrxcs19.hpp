...
// (DO NOT EDIT: machine generated header) 'dclfrxcs19.pas' rev: 26.00 (Windows)

#ifndef Dclfrxcs19HPP
#define Dclfrxcs19HPP
...
#include <frxRegCS.hpp>	// Pascal unit
...
#include <frxServer.hpp>	// Pascal unit

//-- user supplied -----------------------------------------------------------

namespace Dclfrxcs19
{
//-- type declarations -------------------------------------------------------
//-- var, const, procedure ---------------------------------------------------
}	/* namespace Dclfrxcs19 */
#if !defined(DELPHIHEADER_NO_IMPLICIT_NAMESPACE_USE) && !defined(NO_USING_NAMESPACE_DCLFRXCS19)
using namespace Dclfrxcs19;
#endif
#pragma pack(pop)
#pragma option pop
