...
// (DO NOT EDIT: machine generated header) 'dclfs19.pas' rev: 26.00 (Windows)
...
#include <fs_ireg.hpp>	// Pascal unit
...
#include <fs_iextctrlsrtti.hpp>	// Pascal unit
#include <fs_idialogsrtti.hpp>	// Pascal unit
#include <fs_iinirtti.hpp>	// Pascal unit
#include <fs_imenusrtti.hpp>	// Pascal unit
...
#include <fs_tree.hpp>	// Pascal unit
...
#if !defined(DELPHIHEADER_NO_IMPLICIT_NAMESPACE_USE) && !defined(NO_USING_NAMESPACE_DCLFS19)
using namespace Dclfs19;
#endif
#pragma pack(pop)
#pragma option pop
