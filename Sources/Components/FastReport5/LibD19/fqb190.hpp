...
// (DO NOT EDIT: machine generated header) 'fqb190.pas' rev: 26.00 (Windows)
...
#include <fqbLinkForm.hpp>	// Pascal unit
#include <fqbUtils.hpp>	// Pascal unit
#include <fqbDesign.hpp>	// Pascal unit
...
#if !defined(DELPHIHEADER_NO_IMPLICIT_NAMESPACE_USE) && !defined(NO_USING_NAMESPACE_FQB190)
using namespace Fqb190;
#endif
#pragma pack(pop)
#pragma option pop
