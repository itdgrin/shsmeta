...
'g page"/><StrRes Name="clLoading" Text="Loading file..."/><StrRes Name="clPageOf" Text="Page %d of %d"/><StrRes Name="clOf" Text="of %d"/><StrRes Name' + 
'="clFirstPass" Text="First pass: page "/><StrRes Name="clNoPrinters" Text="No printers installed on your system"/><StrRes Name="clDecompressError" Tex' + 
't="Stream decompress error"/><StrRes Name="crFillMx" Text="Filling the cross-tab..."/><StrRes Name="crBuildMx" Text="Building the cross-tab..."/><StrR' + 
'es Name="prRunningFirst" Text="First pass: page %d"/><StrRes Name="prRunning" Text="Preparing page %d"/><StrRes Name="prPrinting" Text="Printing page ' + 
...
'><StrRes Name="uChar" Text="chr"/><StrRes Name="dupDefault" Text="Default"/><StrRes Name="dupVert" Text="Vertical"/><StrRes Name="dupHorz" Text="Horiz' + 
'ontal"/><StrRes Name="dupSimpl" Text="Simplex"/><StrRes Name="SLangNotFound" Text="Language ''%s'' not found"/><StrRes Name="SInvalidLanguage" Text="Inv' + 
'alid language definition"/><StrRes Name="SIdRedeclared" Text="Identifier redeclared: "/><StrRes Name="SUnknownType" Text="Unknown type: "/><StrRes Nam' + 
'e="SIncompatibleTypes" Text="Incompatible types"/><StrRes Name="SIdUndeclared" Text="Undeclared identifier: "/><StrRes Name="SClassRequired" Text="Cla' + 
'ss type required"/><StrRes Name="SIndexRequired" Text="Index required"/><StrRes Name="SStringError" Text="Strings do not have properties or methods"/>' + 
'<StrRes Name="SClassError" Text="Class %s does not have a default property"/><StrRes Name="SArrayRequired" Text="Array type required"/><StrRes Name="S' + 
'VarRequired" Text="Variable required"/><StrRes Name="SNotEnoughParams" Text="Not enough actual parameters"/><StrRes Name="STooManyParams" Text="Too ma' + 
'ny actual parameters"/><StrRes Name="SLeftCantAssigned" Text="Left side cannot be assigned to"/><StrRes Name="SForError" Text="For loop variable must ' + 
'be numeric variable"/><StrRes Name="SEventError" Text="Event handler must be a procedure"/><StrRes Name="600" Text="Expand all"/><StrRes Name="601" Te' + 
'xt="Collapse all"/><StrRes Name="clStrNotFound" Text="Text not found"/><StrRes Name="clCantRen" Text="Could not rename %s, it was introduced in the an' + 
'cestor report"/><StrRes Name="rave0" Text="Rave Import"/><StrRes Name="rave1" Text="The Rave file doesn''t contain TRaveReport items."/><StrRes Name="r' + 
'ave2" Text="The Rave file contains %d reports. Each report will be converted to one fr3 file. Choose a directory where fr3 files will be saved. Note t' + 
'hat only the last report will be opened in the designer."/><StrRes Name="rave3" Text="Cannot create %s."/><StrRes Name="rave4" Text="Report %s, page %' + 
's."/><StrRes Name="clCirRefNotAllow" Text="Circular child reference is not allowed"/><StrRes Name="clDupName" Text="Duplicate name"/><StrRes Name="clE' + 
'rrorInExp" Text="Error in Calc expression:"/><StrRes Name="expMtm" Text="Timeout expired"/><StrRes Name="erInvalidImg" Text="Invalid image format"/><S' + 
'trRes Name="ReportTitle" Text="ReportTitle"/><StrRes Name="ReportSummary" Text="ReportSummary"/><StrRes Name="PageHeader" Text="PageHeader"/><StrRes N' + 
'ame="PageFooter" Text="PageFooter"/><StrRes Name="Header" Text="Header"/><StrRes Name="Footer" Text="Footer"/><StrRes Name="MasterData" Text="MasterDa' + 
'ta"/><StrRes Name="DetailData" Text="DetailData"/><StrRes Name="SubdetailData" Text="SubdetailData"/><StrRes Name="Data4" Text="Data4"/><StrRes Name="' + 
'Data5" Text="Data5"/><StrRes Name="Data6" Text="Data6"/><StrRes Name="GroupHeader" Text="GroupHeader"/><StrRes Name="GroupFooter" Text="GroupFooter"/>' + 
'<StrRes Name="Child" Text="Child"/><StrRes Name="ColumnHeader" Text="ColumnHeader"/><StrRes Name="ColumnFooter" Text="ColumnFooter"/><StrRes Name="Ove' + 
'rlay" Text="Overlay"/><StrRes Name="2_5_interleaved" Text="2_5_interleaved"/><StrRes Name="2_5_industrial" Text="2_5_industrial"/><StrRes Name="2_5_ma' + 
'trix" Text="2_5_matrix"/><StrRes Name="Code39" Text="Code39"/><StrRes Name="Code39 Extended" Text="Code39 Extended"/><StrRes Name="Code128A" Text="Cod' + 
'e128A"/><StrRes Name="Code128B" Text="Code128B"/><StrRes Name="Code128C" Text="Code128C"/><StrRes Name="Code93" Text="Code93"/><StrRes Name="Code93 Ex' + 
'tended" Text="Code93 Extended"/><StrRes Name="MSI" Text="MSI"/><StrRes Name="PostNet" Text="PostNet"/><StrRes Name="Codebar" Text="Codebar"/><StrRes N' + 
'ame="EAN8" Text="EAN8"/><StrRes Name="EAN13" Text="EAN13"/><StrRes Name="UPC_A" Text="UPC_A"/><StrRes Name="UPC_E0" Text="UPC_E0"/><StrRes Name="UPC_E' + 
'1" Text="UPC_E1"/><StrRes Name="UPC Supp2" Text="UPC Supp2"/><StrRes Name="UPC Supp5" Text="UPC Supp5"/><StrRes Name="EAN128A" Text="EAN128A"/><StrRes' + 
' Name="EAN128B" Text="EAN128B"/><StrRes Name="EAN128C" Text="EAN128C"/><StrRes Name="rpEditRep" Text="Edit Report..."/><StrRes Name="rpEditAlias" Text' + 
'="Edit Fields Aliases..."/></Resources>' + 
' ';
