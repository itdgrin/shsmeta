...
begin
  ...
  begin
    ...
    DrawLine(10, 10, 10, 5);
    DrawLine(10, 10, 5, 10);
    DrawLine(10, Height - 11, 10, Height - 6);
    DrawLine(10, Height - 11, 5, Height - 11);
    DrawLine(Width - 11, 10, Width - 11, 5);
    DrawLine(Width - 11, 10, Width - 6, 10);
    DrawLine(Width - 11, Height - 11, Width - 11, Height - 6);
    DrawLine(Width - 11, Height - 11, Width - 6, Height - 11);
    // draw text
    Font := Self.Font;
    s := 'Sample';
    size := TextExtent(s);
    TextOut((Width - size.cx) div 2, (Height - size.cy) div 2, s);
    // draw frame
    if FFrame <> nil then
      FFrame.Draw(Canvas, 10, 10, Width - 11, Height - 11, 1, 1);
  end;
end;
...
var
  ...
  begin
    ...
    begin
      ...
      Brush.Style := bsSolid;
      Rectangle(5, Y * 16 + 5, Width - 5, Y * 16 + 21);
    end;
  end;
...
begin
  RegisterComponents('Fast Report 5 Design',[TfrxRuler, TfrxScrollBox,
    TfrxColorSelector, TfrxLineSelector
   ]);
end;
