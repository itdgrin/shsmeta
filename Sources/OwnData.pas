...
begin
  ...
  FramePriceMaterials := TSprMaterial.Create(Self, vPriceColumn, Date, 1, True, False, 2);
  ...
  FramePriceMechanizms := TSprMechanizm.Create(Self, vPriceColumn, Date, 2);
  ...
  FrameEquipments := TSprEquipment.Create(Self, vPriceColumn, 2);
