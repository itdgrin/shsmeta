...
procedure TfCalcResourceFact.edtMechCodeFilterChange(Sender: TObject);
begin
...
procedure TfCalcResourceFact.grDevDrawColumnCell(Sender: TObject; const Rect: TRect; DataCol: Integer;
  Column: TColumn; State: TGridDrawState);
begin
...
procedure TfCalcResourceFact.grMaterialBottDrawColumnCell(Sender: TObject; const Rect: TRect; DataCol: Integer;
  Column: TColumn; State: TGridDrawState);
begin
...
procedure TfCalcResourceFact.grMechDrawColumnCell(Sender: TObject; const Rect: TRect; DataCol: Integer;
  Column: TColumn; State: TGridDrawState);
begin
...
procedure TfCalcResourceFact.grMechTitleBtnClick(Sender: TObject; ACol: Integer; Field: TField);
var
  s: string;
begin
...
procedure TfCalcResourceFact.grRatesDrawColumnCell(Sender: TObject; const Rect: TRect; DataCol: Integer;
  Column: TColumn; State: TGridDrawState);
begin
...
procedure TfCalcResourceFact.mReplaceClick(Sender: TObject);
var
...
procedure TfCalcResourceFact.qrDevicesBeforePost(DataSet: TDataSet);
var
...
procedure TfCalcResourceFact.qrDevicesPROC_PODRChange(Sender: TField);
var
  e: TFieldNotifyEvent;
begin
  try
...
procedure TfCalcResourceFact.qrDevicesPROC_ZACChange(Sender: TField);
var
  e: TFieldNotifyEvent;
begin
  try
...
procedure TfCalcResourceFact.qrDevicesTRANSP_PROC_PODRChange(Sender: TField);
var
  e: TFieldNotifyEvent;
begin
  try
...
procedure TfCalcResourceFact.qrDevicesTRANSP_PROC_ZACChange(Sender: TField);
var
  e: TFieldNotifyEvent;
begin
  try
...
procedure TfCalcResourceFact.qrMaterialDataAfterOpen(DataSet: TDataSet);
begin
  if CheckQrActiveEmpty(DataSet) then
    CalcFooter;
end;

procedure TfCalcResourceFact.qrMaterialDataBeforeOpen(DataSet: TDataSet);
begin
...
procedure TfCalcResourceFact.qrMaterialDataBeforePost(DataSet: TDataSet);
var
  priceQ: string;
begin
  if (Application.MessageBox('Сохранить изменения?', 'Смета', MB_YESNO + MB_ICONQUESTION + MB_TOPMOST)
...
procedure TfCalcResourceFact.qrMaterialDataMAT_PROC_PODRChange(Sender: TField);
var
  e: TFieldNotifyEvent;
begin
  try
...
procedure TfCalcResourceFact.qrMaterialDataMAT_PROC_ZACChange(Sender: TField);
var
  e: TFieldNotifyEvent;
begin
  try
...
procedure TfCalcResourceFact.qrMaterialDataTRANSP_PROC_PODRChange(Sender: TField);
var
  e: TFieldNotifyEvent;
begin
  try
...
procedure TfCalcResourceFact.qrMaterialDataTRANSP_PROC_ZACChange(Sender: TField);
var
  e: TFieldNotifyEvent;
begin
  try
...
procedure TfCalcResourceFact.qrMechDataBeforePost(DataSet: TDataSet);
var
  priceQ, priceQ1: string;
begin
  if (Application.MessageBox('Сохранить изменения?', 'Смета', MB_YESNO + MB_ICONQUESTION + MB_TOPMOST)
...
procedure TfCalcResourceFact.qrMechDataPROC_PODRChange(Sender: TField);
var
  e: TFieldNotifyEvent;
begin
  try
...
procedure TfCalcResourceFact.qrMechDataPROC_ZACChange(Sender: TField);
var
  e: TFieldNotifyEvent;
begin
  try
