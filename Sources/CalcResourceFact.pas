    ...
    1:
      begin
        ...
        FastExecSQL('INSERT INTO fact_data'#13 +
          ...
          'WHERE ((DELETED = 0) OR (:SHOW_DELETED)) AND CONSIDERED = 1 AND NOT EXISTS(SELECT fact_data_id FROM fact_data WHERE ID_ACT=:ID_ACT1 AND ID_TYPE_DATA=:ID_TYPE_DATA1 AND ID_TABLES=ID)'#13
