...
const SSRItems: array[0..12, 0..2] of string =
  (('90.10','ÑÐÅÄÑÒÂÀ ÍÀ ÍÅÏÐÅÄÂÈÄÅÍÍÛÅ ÐÀÁÎÒÛ È ÇÀÒÐÀÒÛ','0'),
...
begin
  ...
  try
    ...
    begin
      ...
      begin
        NullLine(); //Çàíóëÿåì âñå ñòðîêè è ãëàâû
    ...
    begin
      ...
      begin
        ...
        TmpLine := Line82;   //Âîçìîæííî ýòî ëèøíåå
        CalcLineWithKoef(TmpLine);
        AssignLineIfNoNull(TmpLine);
      end;
