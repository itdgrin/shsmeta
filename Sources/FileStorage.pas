...
type
  ...
  // Функция открывает токумент, если в AData заполнено поле doc_id, иначе - предлогает заполнить это поле
...
begin
  ...
  begin
    case Application.MessageBox('Выбранная запись не звязана ни с одним из документов из ханилища.' + #13#10 +
